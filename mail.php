...
if ($name == "") {
    ...
    $headers .= 'From:  inbio <ilyesbarbou@gmail.com>' . "\r\n";
    $headers .= 'cc: ilyesbarbou@gmail.com' . "\r\n";
    $headers .= 'bcc:ilyesbarbou@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f ilyesbarbou@gmail.com');
